import datetime
from sqlalchemy import create_engine, Column, BigInteger, DateTime, ForeignKey, Integer, String, Sequence
...
class ScanResult(Base):
    ...
    id = Column(BigInteger, Sequence('scan_results_id_seq'), primary_key=True)
